...
const RestaurantDetails = () => {
  ...
  return (
    <div className='px-5 lg:px-20'>
      <section>
        <h3 className='text-gray-500 py-2 mt-10'>Home/India/Great Indian Foodie Bros/3</h3>
        <div>
            <Grid container spacing = {2}>
                ...
                <Grid item xs = {12} lg = {6}>
                    <img className='w-full h-[40vh] object-cover' 
                    src='https://b.zmtcdn.com/data/collections/684397cd092de6a98862220e8cc40aca_1709810207.png' alt = ''/>
                </Grid>
                <Grid item xs = {12} lg = {6}>
                    <img className='w-full h-[40vh] object-cover' 
        ...
        <div className='pt-3 pb-5'>
            <h1 className = "text-4xl font-semibold"> Great Indian Foodie Bros</h1>
            <p className='text-gray-500 mt-1'>
                agjakgjnskfjhbsjkvnasdvkahdsnvavkjnbakjvnadkfbvkajvfmasmvjamdvnskjdvnsvjncjknavfnhsv
            </p>
